...
static const u_char SUN_JKS_ALGO_ID[] = { 43,6,1,4,1,42,2,17,1,1 };
...
CJKS_DLL void cjks_sun_jks_crypt(const u_char *src, u_char *dest, size_t len, u_char *iv, const char *password, size_t plen);
CJKS_DLL int cjks_sun_jks_decrypt(const u_char *data, u_char *dest, int dlen, const char *password, size_t plen);
